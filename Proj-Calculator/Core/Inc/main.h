...
/* Private defines -----------------------------------------------------------*/
#define SEG2_KR2_Pin GPIO_PIN_2
#define SEG2_KR2_GPIO_Port GPIOE
#define SEG3_KR3_Pin GPIO_PIN_3
#define SEG3_KR3_GPIO_Port GPIOE
...
#define SEG0_KR0_Pin GPIO_PIN_0
#define SEG0_KR0_GPIO_Port GPIOE
#define SEG1_KR1_Pin GPIO_PIN_1
#define SEG1_KR1_GPIO_Port GPIOE
