...
static void MX_GPIO_Init(void) {
    ...
    HAL_GPIO_WritePin(GPIOE, SEG2_KR2_Pin | SEG3_KR3_Pin | SEG4_Pin | SEG5_Pin
                      | SEG6_Pin | SEG7_Pin | SEG0_KR0_Pin | SEG1_KR1_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOD, DIG0_Pin | DIG1_Pin | DIG2_Pin | DIG3_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pins : SEG2_KR2_Pin SEG3_KR3_Pin SEG4_Pin SEG5_Pin
                             SEG6_Pin SEG7_Pin SEG0_KR0_Pin SEG1_KR1_Pin */
    GPIO_InitStruct.Pin = SEG2_KR2_Pin | SEG3_KR3_Pin | SEG4_Pin | SEG5_Pin
        | SEG6_Pin | SEG7_Pin | SEG0_KR0_Pin | SEG1_KR1_Pin;
